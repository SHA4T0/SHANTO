...
def do_zip_update():
    ...
    if success:
        ...
        mesgdcrt.SuccessMessage("SHA4T0 was updated to the latest version")
        ...
        mesgdcrt.FailureMessage("Unable to update SHA4T0.")
...
def check_for_updates():
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("SHA4T0 is up-to-date")

        mesgdcrt.GeneralMessage("Starting SHA4T0")
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("SHA4T0 was created by SpeedX")
...
if sys.version_info[0] != 3:
    ...
    mesgdcrt.FailureMessage("SHA4T0 will work only in Python v3")
...
description = """SHA4T0 - Your Friendly Spammer Application
...
parser.add_argument("-call", "--call", action="store_true",
                    ...
                    help="start SHA4T0with CALL Bomb mode")
